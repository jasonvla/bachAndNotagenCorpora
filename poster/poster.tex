  ...
  \begin{columns}[t]
    \begin{column}{0.47\textwidth}
      \begin{block}{Overview: Performance Per Participant}
        \vspace{0.3em}
        \centering
        \includegraphics[width=\textwidth, height=0.11\textheight, keepaspectratio]{plots/corr_vs_incorr_indiv.png}
        \par\vspace{0.3em}
    ...
    \begin{column}{0.47\textwidth}
      \begin{block}{Stimuli Discrimination Accuracy}
        \vspace{0.3em}
        \centering
        \includegraphics[width=0.85\textwidth, height=0.11\textheight, keepaspectratio]{plots/stimuli_comp.png}
        \par\vspace{0.3em}
